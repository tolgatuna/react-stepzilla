            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    this.props.onCancel ? _react2.default.createElement(
                        'button',
                        {
                            disabled: this.state.showFinishBtn ? true : false,
                            className: props.cancelButtonCls,
                    ...
                    this.props.onFinish ? _react2.default.createElement(
                        'button',
                        {
                            disabled: this.state.showFinishBtn ? false : true,
                            className: props.finishButtonCls,
                            onClick: function onClick() {
                                _this6.finish();
                            },
                            id: 'finish-button'
...
StepZilla.defaultProps = {
    ...
    cancelButtonCls: "btn btn-next btn-primary btn-lg",
    finishButtonText: "Finish",
    finishButtonCls: "btn btn-next btn-primary btn-lg",
